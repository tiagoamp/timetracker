...
formatter.scenario({
  "name": "Delete Time Entry for User",
  "description": "",
  "keyword": "Scenario",
  "tags": [
    {
...
formatter.step({
  "name": "send a Delete request for Time Entry",
  "keyword": "And "
});
formatter.match({
  "location": "TimeSteps.send_a_Delete_request_for_Time_Entry()"
});
formatter.result({
  "status": "passed"
});
...
formatter.step({
  "name": "send a Get request for User Time entries",
  "keyword": "And "
});
formatter.match({
  "location": "TimeSteps.send_a_Get_request_for_User_Time_entries()"
});
formatter.result({
  "status": "passed"
});
...
formatter.step({
  "name": "send a Get request by id of Time entry",
  "keyword": "And "
});
formatter.match({
  "location": "TimeSteps.send_a_Get_request_by_id_of_Time_entry()"
});
formatter.result({
  "status": "passed"
});
